	...
	*/	
	...
	/*
		type_info SavingsAccount::typeid = {
							"SavingsAccount", 
							{&BankAccount::typeid, 0,
							 &Profitable::typeid, 16, 0}
						};
		int SavingsAccount::vtbl1[] = {
		...
		int SavingsAccount::vtbl2[] = {
				&SavingsAccount::typeid,
				&SavingsAccount::AddInterestThunk,
				&SavingsAccount::~SavingsAccountThunk,
